...
protocol YouBikeManagerDelegate {
    
    func reloadWhenReceivedData()
...
class ViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,YouBikeManagerDelegate {
    ...
    var getStations: [String: AnyObject]?
    override func viewDidLoad() {
        ...
        YouBikeManager.shared.getData(completionHandler:  { stations in
            if let dataArray = self.getStations!["data"] as? [AnyObject] {
